...
GENERAL INFORMATION
Title of Dataset
Exploring sex-biased development via Onthophagus taurus tissue-specific bulk RNA-seq and ATAC-seq
...
May-August 2022 (ATAC-seq data); March 2022-February 2023 (RNA-seq data).
...
CODE/SOFTWARE
Software needed for the following file: ATACseq_read_processing_pipeline.txt
fastqc (v0.11.9)
...
Software needed for the following file: RNAseq_read_processing_pipeline.txt
fastqc (v0.11.9)
...
Software and packages needed for the following file: Otau_sex_diff.R
R (v4.2.2)
